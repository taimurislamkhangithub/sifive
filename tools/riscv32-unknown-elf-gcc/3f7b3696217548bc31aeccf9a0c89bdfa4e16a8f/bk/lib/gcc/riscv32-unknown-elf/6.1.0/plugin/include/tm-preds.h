/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/tmp/riscv-gnu-toolchain.MbcZCn/src/newlib-gcc/gcc/config/riscv/riscv.md'.  */
...
extern int fp_order_operator (rtx, machine_mode);
...
{
  if (c >= CONSTRAINT_G && c <= CONSTRAINT_Q)
    return;
