...
#define MASK_DIV (1 << 0)
#define MASK_EXPLICIT_RELOCS (1 << 1)
#define MASK_FDIV (1 << 2)
#define MASK_MEMCPY (1 << 3)
#define MASK_SAVE_RESTORE (1 << 4)
#define MASK_64BIT (1 << 5)
#define MASK_ATOMIC (1 << 6)
#define MASK_DOUBLE_FLOAT (1 << 7)
#define MASK_HARD_FLOAT (1 << 8)
#define MASK_MUL (1 << 9)
#define MASK_RVC (1 << 10)
...
enum opt_code
{
  ...
  OPT_fdeclone_ctor_dtor = 606,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 607,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 608,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 609, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 610,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 611,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 612,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 613,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 614,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 615,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 616,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 617,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 618,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 619, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 620,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 621,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 622,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 623,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 624,                /* -fdirectives-only */
  OPT_fdisable_ = 625,                       /* -fdisable- */
  OPT_fdisable_assertions = 626,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 627,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 628,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 629,         /* -fdollars-in-identifiers */
  OPT_fdse = 630,                            /* -fdse */
  OPT_fdump_ = 631,                          /* -fdump- */
  OPT_fdump_ada_spec = 632,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 633,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 634, */                /* -fdump-core */
  OPT_fdump_final_insns = 635,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 636,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 637,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 638,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 639,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 640,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 641,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 642, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 643,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 644,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 645,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 646,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 647,                 /* -fearly-inlining */
  OPT_felide_constructors = 648,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 649,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 650, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 651,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 652,        /* -femit-class-debug-always */
  OPT_femit_class_file = 653,                /* -femit-class-file */
  OPT_femit_class_files = 654,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 655,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 656,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 657,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 658,                        /* -fenable- */
  OPT_fenable_assertions = 659,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 660,             /* -fenable-assertions= */
  OPT_fencoding_ = 661,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 662,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 663, */           /* -fenum-int-equiv */
  OPT_fexceptions = 664,                     /* -fexceptions */
  OPT_fexcess_precision_ = 665,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 666,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 667,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 668,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 669,                       /* -fextdirs= */
  OPT_fextended_identifiers = 670,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 671,                /* -fextern-tls-init */
  OPT_fexternal_blas = 672,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 673, */       /* -fexternal-templates */
  OPT_ff2c = 674,                            /* -ff2c */
  OPT_ffast_math = 675,                      /* -ffast-math */
  OPT_ffat_lto_objects = 676,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 677,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 678,               /* -ffinite-math-only */
  OPT_ffixed_ = 679,                         /* -ffixed- */
  OPT_ffixed_form = 680,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 681,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 682,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 683,                    /* -ffloat-store */
  OPT_ffor_scope = 684,                      /* -ffor-scope */
  /* OPT_fforce_addr = 685, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 686,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 687,              /* -fforward-propagate */
  OPT_ffp_contract_ = 688,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 689,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 690,                      /* -ffpe-trap= */
  OPT_ffree_form = 691,                      /* -ffree-form */
  OPT_ffree_line_length_ = 692,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 693,          /* -ffree-line-length-none */
  OPT_ffreestanding = 694,                   /* -ffreestanding */
  OPT_ffriend_injection = 695,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 696,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 697,                   /* -ffunction-cse */
  OPT_ffunction_sections = 698,              /* -ffunction-sections */
  OPT_fgcse = 699,                           /* -fgcse */
  OPT_fgcse_after_reload = 700,              /* -fgcse-after-reload */
  OPT_fgcse_las = 701,                       /* -fgcse-las */
  OPT_fgcse_lm = 702,                        /* -fgcse-lm */
  OPT_fgcse_sm = 703,                        /* -fgcse-sm */
  OPT_fgnat_encodings_ = 704,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 705,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 706,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 707,                         /* -fgnu-tm */
  OPT_fgnu_unique = 708,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 709,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 710,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 711,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 712,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 713,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 714,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 715,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 716,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 717,                       /* -fgraphite */
  OPT_fgraphite_identity = 718,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 719,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 720, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 721, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 722,           /* -fhash-synchronization */
  /* OPT_fhelp = 723, */                     /* -fhelp */
  /* OPT_fhelp_ = 724, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 725,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 726, */                /* -fhonor-std */
  OPT_fhosted = 727,                         /* -fhosted */
  /* OPT_fhuge_objects = 728, */             /* -fhuge-objects */
  OPT_fident = 729,                          /* -fident */
  OPT_fif_conversion = 730,                  /* -fif-conversion */
  OPT_fif_conversion2 = 731,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 732,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 733,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 734,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 735,             /* -fimplicit-templates */
  OPT_findirect_classes = 736,               /* -findirect-classes */
  OPT_findirect_dispatch = 737,              /* -findirect-dispatch */
  OPT_findirect_inlining = 738,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 739,         /* -finhibit-size-directive */
  OPT_finit_character_ = 740,                /* -finit-character= */
  OPT_finit_integer_ = 741,                  /* -finit-integer= */
  OPT_finit_local_zero = 742,                /* -finit-local-zero */
  OPT_finit_logical_ = 743,                  /* -finit-logical= */
  OPT_finit_real_ = 744,                     /* -finit-real= */
  OPT_finline = 745,                         /* -finline */
  OPT_finline_atomics = 746,                 /* -finline-atomics */
  OPT_finline_functions = 747,               /* -finline-functions */
  OPT_finline_functions_called_once = 748,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 749, */            /* -finline-limit- */
  OPT_finline_limit_ = 750,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 751,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 752,         /* -finline-small-functions */
  OPT_finput_charset_ = 753,                 /* -finput-charset= */
  OPT_finstrument_functions = 754,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 755,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 756,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 757,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 758,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 759,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 760,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 761,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 762,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 763,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 764,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 765,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 766, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 767,                    /* -fipa-profile */
  OPT_fipa_pta = 768,                        /* -fipa-pta */
  OPT_fipa_pure_const = 769,                 /* -fipa-pure-const */
  OPT_fipa_ra = 770,                         /* -fipa-ra */
  OPT_fipa_reference = 771,                  /* -fipa-reference */
  OPT_fipa_sra = 772,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 773, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 774,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 775,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 776,              /* -fira-loop-pressure */
  OPT_fira_region_ = 777,                    /* -fira-region= */
  OPT_fira_share_save_slots = 778,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 779,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 780,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 781,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 782,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 783,               /* -fivar-visibility= */
  OPT_fivopts = 784,                         /* -fivopts */
  OPT_fjni = 785,                            /* -fjni */
  OPT_fjump_tables = 786,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 787,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 788,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 789,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 790,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 791,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 792, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 793,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 794,             /* -fleading-underscore */
  OPT_flifetime_dse = 795,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 796,                  /* -flifetime-dse= */
  OPT_flinker_output_ = 797,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 798,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 799,                    /* -flocal-ivars */
  /* OPT_floop_block = 800, */               /* -floop-block */
  /* OPT_floop_flatten = 801, */             /* -floop-flatten */
  /* OPT_floop_interchange = 802, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 803,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 804, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 805,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 806, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 807, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 808,                      /* -flra-remat */
  OPT_flto = 809,                            /* -flto */
  OPT_flto_compression_level_ = 810,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 811,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 812,                 /* -flto-partition= */
  OPT_flto_report = 813,                     /* -flto-report */
  OPT_flto_report_wpa = 814,                 /* -flto-report-wpa */
  OPT_flto_ = 815,                           /* -flto= */
  OPT_fltrans = 816,                         /* -fltrans */
  OPT_fltrans_output_list_ = 817,            /* -fltrans-output-list= */
  OPT_fmain_ = 818,                          /* -fmain= */
  OPT_fmath_errno = 819,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 820,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 821,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 822,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 823,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 824,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 825,                     /* -fmem-report */
  OPT_fmem_report_wpa = 826,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 827,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 828,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 829,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 830,                /* -fmessage-length= */
  OPT_fmodule_private = 831,                 /* -fmodule-private */
  OPT_fmodulo_sched = 832,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 833,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 834,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 835,                  /* -fms-extensions */
  /* OPT_fmudflap = 836, */                  /* -fmudflap */
  /* OPT_fmudflapir = 837, */                /* -fmudflapir */
  /* OPT_fmudflapth = 838, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 839, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 840, */                  /* -fnew-abi */
  OPT_fnext_runtime = 841,                   /* -fnext-runtime */
  OPT_fnil_receivers = 842,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 843, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 844,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 845,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 846, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 847,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 848,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 849,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 850,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 851,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 852,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 853,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 854,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 855,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 856,                   /* -foffload-abi= */
  OPT_foffload_ = 857,                       /* -foffload= */
  OPT_fomit_frame_pointer = 858,             /* -fomit-frame-pointer */
  OPT_fopenacc = 859,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 860,                   /* -fopenacc-dim= */
  OPT_fopenmp = 861,                         /* -fopenmp */
  OPT_fopenmp_simd = 862,                    /* -fopenmp-simd */
  OPT_foperator_names = 863,                 /* -foperator-names */
  OPT_fopt_info = 864,                       /* -fopt-info */
  OPT_fopt_info_ = 865,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 866, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 867,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 868,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 869,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 870, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 871,              /* -foutput-class-dir= */
  OPT_fpack_derived = 872,                   /* -fpack-derived */
  OPT_fpack_struct = 873,                    /* -fpack-struct */
  OPT_fpack_struct_ = 874,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 875,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 876,              /* -fpcc-struct-return */
  OPT_fpch_deps = 877,                       /* -fpch-deps */
  OPT_fpch_preprocess = 878,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 879,                     /* -fpeel-loops */
  OPT_fpeephole = 880,                       /* -fpeephole */
  OPT_fpeephole2 = 881,                      /* -fpeephole2 */
  OPT_fpermissive = 882,                     /* -fpermissive */
  OPT_fpic = 883,                            /* -fpic */
  OPT_fpie = 884,                            /* -fpie */
  OPT_fplan9_extensions = 885,               /* -fplan9-extensions */
  OPT_fplt = 886,                            /* -fplt */
  OPT_fplugin_arg_ = 887,                    /* -fplugin-arg- */
  OPT_fplugin_ = 888,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 889,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 890,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 891,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 892,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 893,                   /* -fpreprocessed */
  OPT_fpretty_templates = 894,               /* -fpretty-templates */
  OPT_fprofile = 895,                        /* -fprofile */
  OPT_fprofile_arcs = 896,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 897,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 898,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 899,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 900,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 901,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 902,                 /* -fprofile-report */
  OPT_fprofile_use = 903,                    /* -fprofile-use */
  OPT_fprofile_use_ = 904,                   /* -fprofile-use= */
  OPT_fprofile_values = 905,                 /* -fprofile-values */
  OPT_fprotect_parens = 906,                 /* -fprotect-parens */
  OPT_frandom_seed = 907,                    /* -frandom-seed */
  OPT_frandom_seed_ = 908,                   /* -frandom-seed= */
  OPT_frange_check = 909,                    /* -frange-check */
  OPT_freal_4_real_10 = 910,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 911,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 912,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 913,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 914,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 915,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 916,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 917,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 918,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 919,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 920,                /* -frecord-marker=8 */
  OPT_frecursive = 921,                      /* -frecursive */
  OPT_freduced_reflection = 922,             /* -freduced-reflection */
  OPT_free = 923,                            /* -free */
  OPT_freg_struct_return = 924,              /* -freg-struct-return */
  /* OPT_fregmove = 925, */                  /* -fregmove */
  OPT_frename_registers = 926,               /* -frename-registers */
  OPT_freorder_blocks = 927,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 928,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 929,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 930,              /* -freorder-functions */
  OPT_frepack_arrays = 931,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 932,           /* -freplace-objc-classes */
  OPT_frepo = 933,                           /* -frepo */
  OPT_freport_bug = 934,                     /* -freport-bug */
  OPT_frequire_return_statement = 935,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 936,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 937, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 938,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 939,                    /* -fresolution= */
  OPT_frounding_math = 940,                  /* -frounding-math */
  OPT_frtti = 941,                           /* -frtti */
  OPT_fsanitize_coverage_trace_pc = 942,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 943,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 944,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 945,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 946,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 947,                      /* -fsanitize= */
  OPT_fsaw_java_file = 948,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 949,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 950,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 951,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 952,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 953,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 954,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 955,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 956,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 957,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 958,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 959,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 960,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 961,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 962,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 963,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 964,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 965,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 966, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 967,                /* -fschedule-fusion */
  OPT_fschedule_insns = 968,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 969,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 970,              /* -fsecond-underscore */
  OPT_fsection_anchors = 971,                /* -fsection-anchors */
  /* OPT_fsee = 972, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 973,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 974,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 975, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 976,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 977,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 978,         /* -fsemantic-interposition */
  OPT_fshort_enums = 979,                    /* -fshort-enums */
  OPT_fshort_wchar = 980,                    /* -fshort-wchar */
  OPT_fshow_column = 981,                    /* -fshow-column */
  OPT_fshrink_wrap = 982,                    /* -fshrink-wrap */
  ...
  OPT_fsource_filename_ = 991,               /* -fsource-filename= */
  OPT_fsource_ = 992,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 993,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_paths = 994,                    /* -fsplit-paths */
  OPT_fsplit_stack = 995,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 996,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 997, */                 /* -fsquangle */
  OPT_fssa_backprop = 998,                   /* -fssa-backprop */
  OPT_fssa_phiopt = 999,                     /* -fssa-phiopt */
  OPT_fsso_struct_ = 1000,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1001,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1002, */             /* -fstack-check */
  OPT_fstack_check_ = 1003,                  /* -fstack-check= */
  ...
  OPT_fstore_check = 1015,                   /* -fstore-check */
  ...
  OPT_fsync_libcalls = 1022,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1023,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1024,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1025, */             /* -ftarget-help */
  OPT_ftarget_ = 1026,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1027,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1028, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1029,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1030,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1031, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1032,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1033,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1034,                   /* -ftime-report */
  OPT_ftls_model_ = 1035,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1036,              /* -ftoplevel-reorder */
  OPT_ftracer = 1037,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1038,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1039,        /* -ftrack-macro-expansion= */
  ...
  OPT_fuse_atomic_builtins = 1098,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1099,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1100,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1101,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1102,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1103,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1104,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1105,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1106,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1107,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1108,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1109,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1110,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1111, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1112,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1113,                   /* -fverbose-asm */
  /* OPT_fversion = 1114, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1115,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1116,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1117,                   /* -fvisibility= */
  OPT_fvpt = 1118,                           /* -fvpt */
  /* OPT_fvtable_gc = 1119, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1120, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1121,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1122,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1123,                     /* -fvtv-debug */
  OPT_fweak = 1124,                          /* -fweak */
  OPT_fweb = 1125,                           /* -fweb */
  /* OPT_fwhole_file = 1126, */              /* -fwhole-file */
  OPT_fwhole_program = 1127,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1128,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1129,             /* -fworking-directory */
  OPT_fwpa = 1130,                           /* -fwpa */
  OPT_fwpa_ = 1131,                          /* -fwpa= */
  OPT_fwrapv = 1132,                         /* -fwrapv */
  /* OPT_fxref = 1133, */                    /* -fxref */
  /* OPT_fzee = 1134, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1135,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1136,                     /* -fzero-link */
  OPT_g = 1137,                              /* -g */
  OPT_gant = 1138,                           /* -gant */
  OPT_gcoff = 1139,                          /* -gcoff */
  OPT_gdwarf = 1140,                         /* -gdwarf */
  OPT_gdwarf_ = 1141,                        /* -gdwarf- */
  OPT_gen_decls = 1142,                      /* -gen-decls */
  OPT_ggdb = 1143,                           /* -ggdb */
  OPT_ggnu_pubnames = 1144,                  /* -ggnu-pubnames */
  OPT_gnat = 1145,                           /* -gnat */
  OPT_gnatO = 1146,                          /* -gnatO */
  OPT_gno_pubnames = 1147,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1148,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1149,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1150,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1151,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1152,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1153,                   /* -gsplit-dwarf */
  OPT_gstabs = 1154,                         /* -gstabs */
  OPT_gstabs_ = 1155,                        /* -gstabs+ */
  ...
  OPT_mabi_ = 1179,                          /* -mabi= */
  OPT_march_ = 1180,                         /* -march= */
  OPT_mbranch_cost_ = 1181,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1182,                       /* -mcmodel= */
  OPT_mdiv = 1183,                           /* -mdiv */
  OPT_mexplicit_relocs = 1184,               /* -mexplicit-relocs */
  OPT_mfdiv = 1185,                          /* -mfdiv */
  OPT_mmemcpy = 1186,                        /* -mmemcpy */
  OPT_mplt = 1187,                           /* -mplt */
  OPT_msave_restore = 1188,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1189,             /* -msmall-data-limit= */
  OPT_mtune_ = 1190,                         /* -mtune= */
  OPT_n = 1191,                              /* -n */
  OPT_no_canonical_prefixes = 1192,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1193,              /* -no-integrated-cpp */
  OPT_no_pie = 1194,                         /* -no-pie */
  OPT_nocpp = 1195,                          /* -nocpp */
  OPT_nodefaultlibs = 1196,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1197,                   /* -nostartfiles */
  OPT_nostdinc = 1198,                       /* -nostdinc */
  OPT_nostdinc__ = 1199,                     /* -nostdinc++ */
  OPT_nostdlib = 1200,                       /* -nostdlib */
  OPT_o = 1201,                              /* -o */
  OPT_p = 1202,                              /* -p */
  OPT_pass_exit_codes = 1203,                /* -pass-exit-codes */
  /* OPT_pedantic = 1204, */                 /* -pedantic */
  OPT_pedantic_errors = 1205,                /* -pedantic-errors */
  OPT_pg = 1206,                             /* -pg */
  OPT_pie = 1207,                            /* -pie */
  OPT_pipe = 1208,                           /* -pipe */
  ...
  OPT_quiet = 1220,                          /* -quiet */
  OPT_r = 1221,                              /* -r */
  OPT_remap = 1222,                          /* -remap */
  OPT_s = 1223,                              /* -s */
  OPT_s_bc_abi = 1224,                       /* -s-bc-abi */
  OPT_save_temps = 1225,                     /* -save-temps */
  OPT_save_temps_ = 1226,                    /* -save-temps= */
  OPT_shared = 1227,                         /* -shared */
  OPT_shared_libgcc = 1228,                  /* -shared-libgcc */
  /* OPT_specs = 1229, */                    /* -specs */
  OPT_specs_ = 1230,                         /* -specs= */
  OPT_static = 1231,                         /* -static */
  OPT_static_libasan = 1232,                 /* -static-libasan */
  OPT_static_libgcc = 1233,                  /* -static-libgcc */
  OPT_static_libgcj = 1234,                  /* -static-libgcj */
  OPT_static_libgfortran = 1235,             /* -static-libgfortran */
  OPT_static_libgo = 1236,                   /* -static-libgo */
  OPT_static_liblsan = 1237,                 /* -static-liblsan */
  OPT_static_libmpx = 1238,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1239,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1240,               /* -static-libstdc++ */
  OPT_static_libtsan = 1241,                 /* -static-libtsan */
  OPT_static_libubsan = 1242,                /* -static-libubsan */
  /* OPT_std_c__03 = 1243, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1244, */                /* -std=c++0x */
  OPT_std_c__11 = 1245,                      /* -std=c++11 */
  OPT_std_c__14 = 1246,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1247, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1248, */                /* -std=c++1y */
  OPT_std_c__1z = 1249,                      /* -std=c++1z */
  OPT_std_c__98 = 1250,                      /* -std=c++98 */
  OPT_std_c11 = 1251,                        /* -std=c11 */
  /* OPT_std_c1x = 1252, */                  /* -std=c1x */
  /* OPT_std_c89 = 1253, */                  /* -std=c89 */
  OPT_std_c90 = 1254,                        /* -std=c90 */
  OPT_std_c99 = 1255,                        /* -std=c99 */
  /* OPT_std_c9x = 1256, */                  /* -std=c9x */
  OPT_std_f2003 = 1257,                      /* -std=f2003 */
  OPT_std_f2008 = 1258,                      /* -std=f2008 */
  OPT_std_f2008ts = 1259,                    /* -std=f2008ts */
  OPT_std_f95 = 1260,                        /* -std=f95 */
  OPT_std_gnu = 1261,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1262, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1263, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1264,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1265,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1266, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1267, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1268,                    /* -std=gnu++1z */
  ...
  OPT_time = 1284,                           /* -time */
  OPT_time_ = 1285,                          /* -time= */
  OPT_traditional = 1286,                    /* -traditional */
  OPT_traditional_cpp = 1287,                /* -traditional-cpp */
  OPT_trigraphs = 1288,                      /* -trigraphs */
  OPT_u = 1289,                              /* -u */
  OPT_undef = 1290,                          /* -undef */
  OPT_v = 1291,                              /* -v */
  OPT_version = 1292,                        /* -version */
  OPT_w = 1293,                              /* -w */
  OPT_wrapper = 1294,                        /* -wrapper */
  OPT_x = 1295,                              /* -x */
  OPT_z = 1296,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
